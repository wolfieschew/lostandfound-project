  ...
  <div class="flex h-screen">
    <div class="w-[15rem] bg-[#124076] text-white">
      ...
      <ul class="mt-6 space-y-2">
        <li>
          <a href="admin_dashboard.php" class="block px-4 py-2 bg-[#1E5CB8]"><i class='bx bxs-dashboard'></i> Dashboard</a>
        </li>
        <li>
          <a href="admin_items_lost.php" class="block px-4 py-2 hover:bg-[#4973b3]"><i class='bx bxs-box'></i> Items Lost</a>
        </li>
        <li>
          <a href="admin_items_found.php" class="block px-4 py-2 hover:bg-[#4973b3]"><i class='bx bxs-box'></i> Items Found</a>
        </li>
        <li>
